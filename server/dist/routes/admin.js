...
router.get("/dashboard/statistics", protect, restrictTo("Admin", "Super Admin"), 
...
router.get("/orders", protect, restrictTo("Admin", "Super Admin"), orderController.getAllOrders);
