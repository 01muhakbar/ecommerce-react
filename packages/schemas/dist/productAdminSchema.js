...
export const createProductSchema = z.object({
    ...
    }).int().positive('Kategori tidak valid.')),
    ...
    salePrice: z.preprocess((val) => {
        ...
        invalid_type_error: 'Harga diskon harus berupa angka.',
    }).positive({ message: 'Harga diskon harus positif.' }).optional().or(z.literal(''))),
    ...
    }).int().min(0, { message: 'Jumlah produk tidak boleh kurang dari 0.' })),
    slug: z.string().min(1, { message: 'Slug tidak boleh kosong.' }).regex(/^[a-z0-9]+(?:-[a-z0-9]+)*$/, 'Slug hanya boleh berisi huruf kecil, angka, dan tanda hubung (-).'),
