                      ...
                      <div className="flex items-start gap-3 sm:gap-4">
                        ...
                        <div className="ml-1 flex shrink-0 flex-col items-end gap-2.5">
                          <button
                            ...
                            className="inline-flex h-7 w-7 items-center justify-center rounded-full text-rose-500 transition hover:bg-rose-50 hover:text-rose-600 disabled:cursor-not-allowed disabled:opacity-45"
                          >
                          ...
                          <div className="inline-flex h-8 items-center rounded-full border border-slate-300 bg-white px-1.5">
                            <button
                              ...
                              className="inline-flex h-6 w-6 items-center justify-center rounded-full text-sm font-semibold text-slate-700 transition hover:bg-slate-100 disabled:cursor-not-allowed disabled:opacity-40"
                            >
                              -
                            </button>
                            <span className="inline-flex min-w-7 items-center justify-center px-1.5 text-sm font-semibold text-slate-900">
                              {quantity}
                            </span>
                            <button
                              type="button"
