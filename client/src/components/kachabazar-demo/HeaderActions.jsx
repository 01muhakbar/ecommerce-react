...
export default function HeaderActions({ totalQty, isAuthenticated, onCartClick }) {
  ...
  return (
    <div className="ml-auto flex shrink-0 items-center gap-2.5 lg:gap-3">
      ...
      <span className="hidden h-6 w-px bg-white/40 lg:block" aria-hidden />
      <Link
        to={accountHref}
        className="inline-flex h-10 w-10 items-center justify-center rounded-full border border-white/40 bg-white text-emerald-700 transition hover:bg-emerald-50 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-white/45 lg:h-11 lg:w-11"
