...
export default function CartIconButton({ to = "/cart", totalQty = 0, tone = "default" }) {
  ...
  return (
    <Link
      to={to}
      className={`relative inline-flex h-10 w-10 items-center justify-center rounded-full border transition focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-emerald-200 sm:h-11 sm:w-11 ${baseClass}`}
